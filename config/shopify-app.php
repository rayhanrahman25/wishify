...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Wishify'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,write_themes,read_orders,write_customers,read_customers,write_script_tags,read_script_tags'),
